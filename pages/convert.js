          ...
          <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-2 sm:gap-4 sm:px-6">
            ...
            {dropdown && (
              ...
              <div className=" justify-center items-center">
                <div className="flex flex-row">
                {dropdown[convertTo] && (
                  <button className="px-3 py-2 rounded-full bg-blue-400 ">
 ...
 {/*---------------------Convert button & output values---------------------*/}
              <div className="flex m-10 justify-center">
                ...
                <button onClick={() => {
                  ...
                  }} className="px-10 py-2 rounded-full bg-green-200 shadow">Convert</button>

              </div>

              <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-1 sm:gap-4 sm:px-6">
                <dt className=" text-lg font-medium text-gray-500 text-center"><p>{convertedValue}</p></dt>
